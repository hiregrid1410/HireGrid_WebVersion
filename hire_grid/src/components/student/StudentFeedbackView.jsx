  ...
  return (
    <div className="std-panel max-w-lg mx-auto animate-in fade-in duration-300">
      <div className="flex items-center mb-4">
        ...
        <h2 className="text-xl font-black text-slate-100 uppercase tracking-wider">Send Feedback</h2>
      </div>
      ...
      {success ? (
        <div className="bg-emerald-500/10 border border-emerald-500/20 p-6 rounded-2xl text-center">
          ...
          <p className="text-emerald-400 font-bold text-sm uppercase tracking-wider mb-2">Thank you!</p>
          <p className="text-xs text-slate-400 mb-6 leading-relaxed">Your feedback has been submitted successfully to system console.</p>
          <button
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-2">
            ...
            <select
              ...
              className="w-full px-4 py-3 rounded-xl border border-slate-850 bg-[#050B14] text-slate-100 text-sm focus:border-emerald-500 outline-none transition-all cursor-pointer"
            >
          ...
          <div className="space-y-2">
            ...
            <textarea
              ...
              className="w-full px-4 py-3 rounded-xl border border-slate-850 bg-[#050B14] text-slate-100 text-sm focus:border-emerald-500 outline-none transition-all resize-none"
              required
            />
          </div>
